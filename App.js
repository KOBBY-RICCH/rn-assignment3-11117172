  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TouchableOpacity style={styles.filterButton}> 
          <Image source={require('./assets/filter.image jpg')} style={styles.filterIcon} /> 
      ...
      <View style={styles.categoriesContainer}>
        ...
        <TouchableOpacity style={styles.categoryCard}>
          ...
          <Text style={styles.categoryTasks}>12 Tasks</Text>c
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryCard}>
          <Image
            style={styles.categoryImage}
        ...
        <TouchableOpacity style={styles.categoryCard}>
          ...
          <Text style={styles.categoryTitle}>Swim</Text>
          <Text style={styles.categoryTasks}>12 Tasks</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
